"""The alpha fixture's probe tool.
...
exactly which wheel is live in the process that answered."""
...
def e2e_market_probe() -> dict:
    """Report the installed distribution version and the serving pid."""
    return {
        "dist_version": importlib.metadata.version("tai-e2e-market-alpha"),
        "pid": os.getpid(),
    }
