"""Per-thread conversation control mode over the public web chat round trip.
...
carries the manual-period exchange (the scripted-LLM continuity read
``test_web_public_chat``/``test_agent_thread_continuity`` use), with the
