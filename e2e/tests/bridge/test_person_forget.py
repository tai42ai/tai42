"""Erasing a linked person over a real bridge conversation.
...
Linking mechanics mirror ``test_tool_person_continuity``; the erase mirrors the
thread-forget door of ``test_thread_delete``.
"""
