"""Request/query/body DTOs and paging constants for the conversation-route doors, plus the
option/section type adapters the send seam coerces raw dicts through."""
